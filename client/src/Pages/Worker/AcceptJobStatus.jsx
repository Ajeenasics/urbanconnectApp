...
import ViewServieceAcceptList from './Interviews/ViewServieceAcceptList';
import WorkerviewWorkreqstatus from './Jobs/WorkerviewWorkreqstatus';
  ...
  return (
    <>
      ...
      <div className="">
        ...
        <button className='workeracceptjobstatus_empbtn ' onClick={() => setView('user')}>Accepted WorkList</button>
        <button className='workeracceptjobstatus_empbtn mx-3' onClick={() => setView('employer')}>Accepted Service
        List</button>
      </div>
        {/* <div style={{display:'flex',marginTop:'-30px',marginLeft:'860px'}}><input
            ...
            <div>
        {view === 'user' ? <WorkerviewWorkreqstatus /> : <ViewServieceAcceptList/>}
      </div>
      </div>
